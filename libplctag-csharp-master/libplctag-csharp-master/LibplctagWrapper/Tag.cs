...
namespace LibplctagWrapper
{
    ...
    public class Tag
    {
        ...
        public Tag(string ipAddress, CpuType cpuType, string name, int elementSize, int elementCount, int debugLevel)
        ...
        /// <param name="elementCount">elements count: 1- single, n-array.</param>
        /// <param name="debugLevel"></param>
        public Tag(string ipAddress, string path, CpuType cpuType, string name, int elementSize, int elementCount, int debugLevel)
        {
